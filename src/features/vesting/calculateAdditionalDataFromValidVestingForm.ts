...
export const calculateAdditionalDataFromValidVestingForm = ({ data: { startDate, totalAmountEther, cliffEnabled, cliffPeriod, cliffAmountEther, vestingPeriod } }: ValidVestingForm) => {
    ...
    const cliffAmount = parseEtherOrZero(
      cliffAmountEther || "0"
    );
