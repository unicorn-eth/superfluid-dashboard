Feature: Auto-wrap page test cases
    ...
    Scenario: Change network buttons in the table
        ...
        And User opens the auto-wrap page from the navigation menu
        And No loading skeletons are visible in the page
        Then All action buttons are changed to switch network buttons on "avalanche-fuji" table

    Scenario: Data shown in the table
        Given "Auto-Wrap Page" is open with "john" connected on "avalanche-fuji"
        And No loading skeletons are visible in the page
        Then Auto-wrap data shown on "avalanche-fuji" is correct
    ...
    Scenario: No permissions set screen + add token button
        Given "Auto-Wrap Page" is open with "alice" connected on "avalanche-fuji"
    ...
    Scenario: Network contracts shown by the table
        Given "Auto-Wrap Page" is open with "john" connected on "avalanche-fuji"
        Then Auto-wrap contract addresses are shown correctly for "avalanche-fuji"
    ...
    Scenario: Close button showing up for a token which already has auto-wrap set up
        ...
        And User selects "avalanche-fuji" as the network for the auto-wrap
