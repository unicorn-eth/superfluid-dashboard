...
Feature: Stream transactional test cases
    ...
    Scenario: Creating a new stream
        ...
        Then All the details to send "1" "fDAIx" per "month" to "0xF9Ce34dFCD3cc92804772F3022AF27bCd5E43Ff2" on "polygon-mumbai" are set in the fields
    ...
    Scenario: Modifying a stream
        ...
        And User restores the last transaction
        Then All the details to send "2" "fDAIx" per "month" to "0xF9Ce34dFCD3cc92804772F3022AF27bCd5E43Ff2" on "polygon-mumbai" are set in the fields
