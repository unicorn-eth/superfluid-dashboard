...
export const LiquidityMover = [
  {
    inputs: [
      {
        internalType: "contract IUniswapSwapRouter",
        name: "_swapRouter",
        type: "address",
      },
      {
        internalType: "contract ISETH",
        name: "_nativeAssetSuperToken",
        type: "address",
      },
    ],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "inAmountForSwap",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "inAmountUsedForSwap",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "contract IERC20",
        name: "outTokenForSwap",
        type: "address",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "outAmountForSwap",
        type: "uint256",
      },
    ],
    name: "LiquidityMoved",
  ...
  {
    inputs: [
      { internalType: "contract Torex", name: "torex", type: "address" },
