...
export const networkDefinition: {
    ...
    goerli: {
        ...chain.goerli,
        blockExplorers: BasePage.ensureDefined(chain.goerli.blockExplorers),
        slugName: "goerli",
        v1ShortName: "goerli",
...
polygon: {
...chain.polygon,
        blockExplorers: BasePage.ensureDefined(chain.polygon.blockExplorers),
        slugName: "polygon",
        v1ShortName: "matic",
        bufferTimeInMinutes: 240,
...
polygonMumbai: {
...chain.polygonMumbai,
        blockExplorers: BasePage.ensureDefined(chain.polygonMumbai.blockExplorers),
...
optimism: {
...chain.optimism,
        blockExplorers: BasePage.ensureDefined(chain.optimism.blockExplorers),
        slugName: "optimism",
...
arbitrum: {
...chain.arbitrum,
        blockExplorers: BasePage.ensureDefined(chain.arbitrum.blockExplorers),
